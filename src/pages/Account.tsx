  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-background pt-32 md:pt-40">
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute -left-12 top-10 h-56 w-56 rounded-full bg-secondary/40 blur-3xl" />
        <div className="absolute right-0 top-64 h-72 w-72 rounded-full bg-accent/30 blur-3xl" />
      </div>

      <section className="section-padding pt-0">
        <div className="container-editorial relative z-10">
          <div className="relative mb-10 overflow-hidden rounded-[2rem] border border-border/70 bg-card/80 p-8 md:p-12">
            <div className="pointer-events-none absolute -right-20 -top-20 h-64 w-64 rounded-full border border-border/50" />
            <div className="pointer-events-none absolute -bottom-28 left-1/3 h-56 w-56 rounded-full bg-secondary/35 blur-3xl" />
            <p className="mb-3 font-sans text-xs uppercase tracking-[0.28em] text-muted-foreground">Babel Account Atelier</p>
            <h1 className="font-serif text-4xl font-light text-foreground md:text-6xl">Your Design Identity</h1>
          ...
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-[360px_1fr]">
            <aside className="rounded-[2rem] border border-border/70 bg-card/75 p-8 backdrop-blur-sm">
              <div className="relative mx-auto mb-6 w-fit">
                <div className="pointer-events-none absolute -inset-4 rounded-full border border-border/50" />
                <Avatar className="h-32 w-32 border border-border/70 shadow-[0_20px_60px_-35px_hsl(var(--foreground)/0.6)]">
              ...
              <p className="text-center font-serif text-2xl leading-tight text-foreground">{accountName}</p>
              ...
              <div className="mb-6 grid grid-cols-2 gap-3">
                ...
                <div className="border border-border/60 bg-background/60 p-3 text-center">
                  ...
                  <p className="mt-1 font-serif text-sm text-foreground">Active</p>
                </div>
              </div>

              <button
                onClick={onSignOut}
                className="flex w-full items-center justify-center gap-2 border border-foreground/30 bg-foreground px-4 py-3 text-xs uppercase tracking-[0.2em] text-background transition-colors hover:bg-foreground/90"
              >
                <LogOut size={14} />
                Sign out
              </button>
            ...
            <div className="space-y-8">
              <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                <div className="group rounded-3xl border border-border/70 bg-card/75 p-6 backdrop-blur-sm transition-transform hover:-translate-y-1">
                  ...
                  <p className="mt-2 font-serif text-xl text-foreground">Quiet Luxury</p>
                </div>
                <div className="group rounded-3xl border border-border/70 bg-card/75 p-6 backdrop-blur-sm transition-transform hover:-translate-y-1">
                  ...
                  <p className="mt-2 font-serif text-xl text-foreground">Stone / Timber</p>
                </div>
                <div className="group rounded-3xl border border-border/70 bg-card/75 p-6 backdrop-blur-sm transition-transform hover:-translate-y-1">
                  ...
                  <p className="mt-2 font-serif text-xl text-foreground">Provider Verified</p>
                </div>
              </div>

              <div className="rounded-[2rem] border border-border/70 bg-card/75 p-8 backdrop-blur-sm md:p-10">
                ...
                <div className="mb-8 grid grid-cols-1 gap-4 md:grid-cols-2">
                  <Link
                    to="/collections"
                    className="group flex items-center justify-between border border-border px-5 py-4 text-xs uppercase tracking-[0.22em] text-muted-foreground transition-colors hover:border-foreground/40 hover:text-foreground"
                  >
